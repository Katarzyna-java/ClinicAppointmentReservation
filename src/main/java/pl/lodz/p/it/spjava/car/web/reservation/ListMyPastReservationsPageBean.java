...
@Named(value = "listMyPastReservationsPageBean")
@ViewScoped
public class ListMyPastReservationsPageBean implements Serializable {
    ...
    public ListMyPastReservationsPageBean() {
    }
    ...
    public void listMyReservations() {
        ...
        try {
            listReservationsDTO = reservationControllerBean.listMyPastReservations(currentDate);
        } catch (AppBaseException ex) {
            Logger.getLogger(ListMyPastReservationsPageBean.class.getName()).log(Level.SEVERE, null, ex);
